-- Oracle Private Agent Factory - Leasing Synthetic Data

-- TABLE 1: LEASE CONTRACTS
...
-- TABLE 2: CUSTOMER CREDIT PROFILE
...
INSERT INTO collections_accounts VALUES ('COL-001','LC-2024-002','CV Teknologi Nusantara','+62-21-5551234','finance@teknosinusantara.co.id',15,12000000,432000000,DATE '2024-10-16',12000000,'REMINDER','Agus Permadi','Send payment reminder via email and WhatsApp',DATE '2024-11-16','First missed payment. Good historical record.');
INSERT INTO collections_accounts VALUES ('COL-002','LC-2024-005','UD Sinar Harapan','+62-411-5559876','owner@sinarharapan.co.id',45,25500000,306000000,DATE '2024-09-15',8500000,'SOFT_COLLECTION','Sri Wahyuni','Phone call and formal demand letter',DATE '2024-11-05','2nd notice. Partial payment last month. Owner difficult to reach.');
INSERT INTO collections_accounts VALUES ('COL-003','LC-2024-003','PT Agro Makmur','+62-31-5554321','cfo@agromakmur.co.id',90,57000000,342000000,DATE '2024-08-01',9500000,'LEGAL','Rizky Ramadan','Coordinate with legal team for formal notice',DATE '2024-11-01','Lease expired. Refuses renewal or return of equipment. Legal escalation initiated.');
INSERT INTO collections_accounts VALUES ('COL-004','LC-2024-006','PT Tambang Sejahtera','+62-542-5556789','treasury@tambangsejahtaera.co.id',10,45000000,2700000000,DATE '2024-10-21',45000000,'REMINDER','Agus Permadi','Send WhatsApp reminder to treasury team',DATE '2024-11-20','Large account. Likely processing delay. Handle with care.');
...
-- TABLE 4: KNOWLEDGE BASE FOR RAG
